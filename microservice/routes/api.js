...
let moviesEndpoint = require("./movies");
let expenseEndpoint = require("./expenseService");
...
router.use("/expenses", expenseEndpoint);
...
let options = {
  swaggerDefinition: {
    ...
    tags: [
      ...
      {
        name: "Movies",
        description: "Get popular  movies from https://www.themoviedb.org/ ",
      },
      {
        name: "Repo",
  ...
  apis: [
    ...
    "routes/posts.js",
    "routes/movies.js",
    "routes/expenseService.js",
    "routes/repo/repo.js",
    "routes/repo/images.js",
  ],
};
